...
#elif defined(CONFIG_EF35_BOARD)
#define ALS_COEF_GA 64 // EF35L-110421
#else
...
int apds9900_set_irq(bool enable)
{
	...
	if ( enable ) {
		// 4.1 enable irq
		request_irq( APDS9900_PS_IRQ, &apds9900_irq_handler, IRQF_TRIGGER_FALLING, "apds9900_ps_irq", 0 );
		if (ret) {
