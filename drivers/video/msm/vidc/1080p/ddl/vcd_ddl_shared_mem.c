	...
	enum vidc_sm_mpeg4_profileinfo profile_info)
{
	...
	if (shared_mem) {
		...
		case VIDC_SM_PROFILE_INFO_ASP:
			DDL_MSG_ERROR("[PANTECH] VIDC_SM_PROFILE_INFO_ASP, vidc_sm_set_mpeg4_profile_override()");
			profile_enforce |= 4;
			break;
		case VIDC_SM_PROFILE_INFO_SP:
			DDL_MSG_ERROR("[PANTECH] VIDC_SM_PROFILE_INFO_SP, vidc_sm_set_mpeg4_profile_override()");
			profile_enforce |= 2;
			break;
		case VIDC_SM_PROFILE_INFO_DISABLE:
		default:
			DDL_MSG_ERROR("[PANTECH] profile_info(%d), vidc_sm_set_mpeg4_profile_override()", profile_info);
			profile_enforce = 0;
			break;
		}
	}
