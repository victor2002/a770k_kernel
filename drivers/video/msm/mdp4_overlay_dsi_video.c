...
#ifndef F_SKYDISP_QBUG_FIX_MIPI_ERROR
...
#ifdef F_SKYDISP_QBUG_FIX_MIPI_ERROR
	dsi_height = mfd->panel_info.yres+1;
#else
...
#ifdef F_SKYDISP_ADD_VSYNC_PUSH
void mdp4_overlay_dsi_wait4vsync(struct msm_fb_data_type *mfd)
{
	unsigned long flag;
...
void mdp4_overlay_dsi_vsync_push(struct msm_fb_data_type *mfd,
			struct mdp4_overlay_pipe *pipe)
{
	...
	mdp4_overlay_dsi_wait4vsync(mfd);
}
#endif
...
void mdp4_dsi_video_overlay(struct msm_fb_data_type *mfd)
{
	...
	uint8 *buf;
	int bpp;
#ifndef F_SKYDISP_ADD_VSYNC_PUSH
	unsigned long flag;
#endif
	struct mdp4_overlay_pipe *pipe;
	...
	mdp4_overlay_rgb_setup(pipe);
#ifdef F_SKYDISP_ADD_VSYNC_PUSH
	mdp4_overlay_dsi_vsync_push(mfd, pipe);
#else
