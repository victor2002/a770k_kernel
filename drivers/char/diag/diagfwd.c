...
FACTORY_HDET_AUTO_CAL_I 	= 0xE2, // MSM, MDM HDET Auto CalÀ» Æù ³»ºÎÀûÀ¸·Î ¼öÇà
FACTORY_RF_PATH_INIT_I	= 0xE3, // RF Switch ÃÊ±âÈ­. ÀÌ°Å ¾ÈÇÏ¸é MDM Rx Div Á¶Á¤ ¾ÈµÊ
FACTORY_EFS_ERASE_I 	= 0xE4, // DM ¸ðµå¿¡¼­ EFS ÃÊ±âÈ­ ¼öÇà
FACTORY_MAGIC_BLOCK_ERASE_I =0xE5,	// MAGIC BLOCK °­Á¦ ÃÊ±âÈ­
FACTORY_ANDROID_SHUTDOWN_I      = 0xE6,
FACTORY_PATTERN_UNLOCK_I	= 0xE7,	// PATTERN AaÂ¡Â¾Y Â¨Ã¹Â©Ã¸AÂ¢Â´ CÂ¨ÂªA|
