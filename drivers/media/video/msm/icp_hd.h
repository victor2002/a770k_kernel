...
#if BOARD_VER_GE(TP15) || ((MODEL_ID == MODEL_EF35L) &&  BOARD_VER_GE(TP10))
//110421 psj
/////////////////////////////////////////
...
#elif BOARD_VER_G(WS10) && BOARD_VER_LE(TP10)
...
#if defined(F_SKYCAM_ADD_CFG_CAF) || defined(F_SKYCAM_FIX_CFG_CAF)
