...
#if MODEL_SKY // PS2.P12095.110720 It is need to check R/W flag even though same address. I think that variable of 'filled' must be TRUE if next->flag is WRITE flag.
