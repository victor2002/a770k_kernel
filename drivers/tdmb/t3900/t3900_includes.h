...
#ifndef _T3900_INCLUDES_H_
#define _T3900_INCLUDES_H_
...
#define TDMB_MSG_INC_BB(fmt, arg...) \
  TDMB_KERN_MSG_ALERT(fmt, ##arg)

#define TDMB_MSG_INC_PKT(fmt, arg...) \
  TDMB_KERN_MSG_ALERT(fmt, ##arg)
...
typedef unsigned long int INC_DOUBLE32,   *INC_PDOUBLE32; // LINUX porting
...
//EI33 0506 netber test½Ã fic ¹ÞÁö ¾Ê±â À§ÇØ Ãß°¡
#define INC_MULTI_CHANNEL_NETBER_NOT_FIC_UPLOAD
#ifdef FEATURE_QTDMB_EBI_IF
#define FEATURE_COMMUNICATION_CHECK
#endif

// TSIF or EBI2
#if defined (FEATURE_QTDMB_TSIF_IF) || defined(FEATURE_INC_T3700_TSIF_MULTI)
#define INC_T3700_USE_TSIF
#else
#define INC_T3700_USE_EBI2
...
#define INC_INTERRUPT_ALL_DISABLE        0xFFFF

#define INC_ADDRESS_IFDELAY_LSB      0xB6
#define INC_ADDRESS_IFDELAY_MID      0xB5
#define INC_ADDRESS_IFDELAY_MSB      0xB4

#define INC_ADDRESS_RFDELAY_LSB      0xB3
#define INC_ADDRESS_RFDELAY_MID      0xB2
#define INC_ADDRESS_RFDELAY_MSB      0xB1

#define INC_AIRPLAY_IF_DLEAY_MAX     1000
#define INC_AIRPLAY_RF_DLEAY_MAX     1100

#define INC_SCAN_IF_DLEAY_MAX        1500//1000
#define INC_SCAN_RF_DLEAY_MAX        1500//10000
...
#define STREAM_PARALLEL_ADDRESS     ebi2_tdmb_base
#else
#define STREAM_PARALLEL_ADDRESS     0
#endif
...
#define T3700_I2C_ID80     0x40
#define T3700_I2C_ID82     0x41

#define MPI_CS_SIZE         (188*8)
#define INC_MPI_MAX_BUFF    (1024*8)
#ifdef INC_MULTI_CHANNEL_ENABLE
#define INC_INTERRUPT_SIZE  (188*24)
#define INC_NETBER_INTERRUPT_SIZE    (768*2)
#else
#define INC_INTERRUPT_SIZE    (188*12)
#define INC_NETBER_INTERRUPT_SIZE    (768*2)
#endif
...
#define INC_FIFO_DEPTH    (1024*20)  //chunk size°¡ 64 FIFO overflow ¹ß»ýÇÏ¿© 10->20 º¯°æ
#else //EBI2
...
typedef struct _tagST_OUTPUT_EWS
{
  ...
  INC_UINT8 ucMsgGovernment; //Þ½ ß·É±
  INC_UINT8 ucMsgID;         //Þ½ È£
  ST_DATE_T stDate;          //Ï½

  INC_INT8 acKinds[4];       //ç³?
  INC_UINT8 cPrecedence;     //ì¼?
  INC_UINT32 ulTime;         //ç³??
  INC_UINT8 ucForm;          //ç³?
  INC_UINT8 ucResionCnt;     //ç³?
