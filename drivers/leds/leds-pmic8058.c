...
//	if(led->brightness)	// p12279 EF33S LED is too dark, so..
...
static int pmic8058_led_probe(struct platform_device *pdev)
{
	...
	//p12279 test....because of SKY log is missing at the booting time
#ifdef CONFIG_EF33_BOARD	
//	pmic8058_led_set(&led_data[PMIC8058_ID_LED_KB_LIGHT].cdev, 102);
//	led_lc_set(&led_data[PMIC8058_ID_LED_KB_LIGHT], 102);
#endif
