...
static struct adie_codec_action_unit voip_idmic_mono_48KHz_osr256_actions[] =
	DMIC1_PRI_MONO_8000_OSR_256;

static struct adie_codec_hwsetting_entry voip_idmic_mono_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = voip_idmic_mono_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(voip_idmic_mono_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile voip_idmic_mono_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = voip_idmic_mono_settings,
	.setting_sz = ARRAY_SIZE(voip_idmic_mono_settings),
};
...
#ifndef NO_VT_SEPARATION
static struct adie_codec_action_unit vt_idmic_mono_48KHz_osr256_actions[] =
	DMIC1_PRI_MONO_8000_OSR_256;

static struct adie_codec_hwsetting_entry vt_idmic_mono_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = vt_idmic_mono_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(vt_idmic_mono_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile vt_idmic_mono_profile = {
	.path_type = ADIE_CODEC_TX,
	.settings = vt_idmic_mono_settings,
	.setting_sz = ARRAY_SIZE(vt_idmic_mono_settings),
};
...
static struct adie_codec_action_unit normal_ispkr_stereo_48KHz_osr256_actions[] =
	SPEAKER_PRI_STEREO_48000_OSR_256;

static struct adie_codec_hwsetting_entry normal_ispkr_stereo_settings[] = {
	{
		.freq_plan = 48000,
		.osr = 256,
		.actions = normal_ispkr_stereo_48KHz_osr256_actions,
		.action_sz = ARRAY_SIZE(normal_ispkr_stereo_48KHz_osr256_actions),
	}
};

static struct adie_codec_dev_profile normal_ispkr_stereo_profile = {
	.path_type = ADIE_CODEC_RX,
	.settings = normal_ispkr_stereo_settings,
	.setting_sz = ARRAY_SIZE(normal_ispkr_stereo_settings),
};
