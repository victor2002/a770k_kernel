...
struct kgsl_platform_data kgsl_pdata = {
	...
	//.pt_va_size = SZ_32M,
	.pt_va_size = SZ_128M, // [PS1] 2011.07.12 Kang Seong-Goo 32M->128M
...
struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_8X60("gsbi_uart_clk",	GSBI12_UART_CLK, "msm_serial_hsl.0",
			OFF),
#if defined(CONFIG_PN544)
	CLK_8X60("gsbi_qup_clk",	GSBI1_QUP_CLK,		"qup_i2c.11", OFF),
#else 
...
#endif
#if 0//def CONFIG_SKY_TDMB_I2C_CMD
    CLK_8X60("gsbi_qup_clk",  GSBI10_QUP_CLK,   &msm_gsbi10_qup_i2c_device.dev, OFF),
#else
	CLK_8X60("gsbi_qup_clk",	GSBI10_QUP_CLK,	"spi_qsd.1", OFF),
#ifdef CONFIG_SKY_BATTERY_MAX17040
	CLK_8X60("gsbi_qup_clk",	GSBI11_QUP_CLK,"qup_i2c.10", OFF),	
#else
#endif	
...
#if defined(CONFIG_PN544)
	CLK_8X60("gsbi_pclk",		GSBI1_P_CLK, "qup_i2c.11", OFF),
#else 
...
// P12095 added 110301
	...
	CLK_8X60("gsbi_pclk",		GSBI11_P_CLK, "qup_i2c.10", OFF),
#else
	...
	CLK_8X60("csi_clk",		CSI1_CLK,	  "msm_camera_s5k6aafx13.0", OFF),
#else
...
#ifdef F_SKYCAM_S5K6AAFX13
	CLK_8X60("csi_vfe_clk",		CSI1_VFE_CLK,	 "msm_camera_s5k6aafx13.0", OFF),	
#else
...
#ifdef F_SKYCAM_S5K6AAFX13
	CLK_8X60("csi_pclk",		CSI1_P_CLK,	 "msm_camera_s5k6aafx13.0", OFF),		
#else
